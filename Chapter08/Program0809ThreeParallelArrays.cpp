...
using namespace std;
/***************************************************************
 * The function findGrades accepts the constant array score, the *
 * non-constant array grades, and the common size of the arrays. *
 * It uses the first array to create the second array. *
 ***************************************************************/
